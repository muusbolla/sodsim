...
{
    class IronfoeHitMH : Ability
    {
        public IronfoeHitMH(PlayerState p) : base(p)
        {
        ...
        public override void Do()
        {
            ...
            if (myPlayer.logging) myPlayer.Log.Add(String.Format("IF{0:F2} | {1:F2} | {2:F2} {3}", dmg, myPlayer.rage, myPlayer.MyContext.Server.Time, oc == Outcome.Crit ? "*CRIT*" : String.Empty));
